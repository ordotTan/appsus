...
var gDefaultNotes = [
    { id: 1, type: 'NoteTxt', isPinned: false, info: { txt: 'I ❤️ React' }, style: { backgroundColor: "lightgoldenrodyellow", color: 'black' } },
    { id: 2, type: 'NoteTodos', isPinned: true, info: { label: 'Shopping List', todos: [{ id: 'fdsfsd', txt: 'Milk', doneAt: null },{ id: 'dsffdsf', txt: 'Bread', doneAt: 1588172672000 },{ id: 'asasd', txt: 'Wine', doneAt: null} ] }, style: { backgroundColor: "#AFAC99", color: 'black' } },
    { id: 3, type: 'NoteTxt', isPinned: false, info: { txt: 'Need to sleep more!' }, style: { backgroundColor: "lightgoldenrodyellow", color: 'black' } },
    { id: 4, type: 'NoteImg', isPinned: true, info: { url: 'https://www.liberaldictionary.com/wp-content/uploads/2019/02/icon-0326.jpg', title: "Spaceship" }, style: { backgroundColor: "#AFAC99",color: 'black'  } },
    ...
    { id: 6, type: 'NoteVideo', isPinned: true, info: { url: 'https://www.youtube.com/watch?v=aOx7cenvPbQ', title: "Coding Academy" }, style: { backgroundColor: "#AFAC99",color: 'black'  } },
    { id: 7, type: 'NoteTxt', isPinned: false, info: { txt: 'Talk with my friedns' }, style: { backgroundColor: "lightgoldenrodyellow", color: 'black' } },
